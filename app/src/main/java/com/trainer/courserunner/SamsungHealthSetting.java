...
public class SamsungHealthSetting extends AppCompatActivity {
        ...
        public void onConnected() {
            ...
            try {
                ...
                if (resultMap.containsValue(Boolean.FALSE)) {
                    ...
                    pmsManager.requestPermissions(mKeySet, SamsungHealthSetting.this).setResultListener(mPermissionListener);
                } else {
                    // Get the current step count and display it
                    // ...
                }
